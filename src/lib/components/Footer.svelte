	...
	<div class="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4">
		...
		<div class="flex shrink-0 flex-col items-end gap-1 sm:flex-row sm:items-center sm:gap-4">
			<div class="flex items-center gap-3">
				...
				<a
					href="https://www.linkedin.com/in/emmanuelhadoux/"
					target="_blank"
					rel="noopener noreferrer"
					class="text-muted-foreground transition-colors hover:text-foreground"
					aria-label="LinkedIn"
				...
				<a
					href="https://x.com/EmmanuelHadoux"
					target="_blank"
					rel="noopener noreferrer"
					class="text-muted-foreground transition-colors hover:text-foreground"
			...
			<span class="text-xs text-muted-foreground/60">© {new Date().getFullYear()} Emmanuel Hadoux</span>
		</div>
	</div>
</footer>
